...
public class InBoxActivity extends FragmentActivity{
	...
	public static final String CITY_NAME = "inBoxCityName";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final String cityName = extras.getString(CITY_NAME);
        ...
        webviewContent.loadUrl(getUrl(this, cityName));
	...
	private String getUrl(Context ctx, String cityName){
        return StringUtils.defaultString(Request.getPageUrl(Page.bulletinboard))
