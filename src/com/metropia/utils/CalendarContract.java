...
//    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    ...
    protected interface CalendarSyncColumns {
         ...
         * <P>Type: TEXT</P>
         */
        public static final String CAL_SYNC1 = legacyApi? "_sync_version" : "cal_sync1";
    ...
    protected interface SyncColumns extends CalendarSyncColumns {
         ...
         * <P>Type: TEXT</P>
         */
        public static final String ACCOUNT_NAME =  legacyApi? "_sync_account" : "account_name";
         ...
         * <P>Type: TEXT</P>
         */
        public static final String ACCOUNT_TYPE = legacyApi? "_sync_account_type" : "account_type";
    ...
    protected interface CalendarColumns {
         ...
         */
        public static final String CALENDAR_COLOR = legacyApi? "color" : "calendar_color";
         ...
         * </P>
         */
        public static final String CALENDAR_DISPLAY_NAME = legacyApi? "displayName" : "calendar_displayName";

        /**
         * The level of access that the user has for the calendar
         * <P>Type: INTEGER (one of the values below)</P>
         */
        public static final String CALENDAR_ACCESS_LEVEL = legacyApi? "access_level" : "calendar_access_level";
         ...
         * <P>Type: INTEGER (boolean)</P>
         */
        public static final String VISIBLE = legacyApi? "selected" : "visible";
...
//        }
    ...
    protected interface EventsColumns {
         ...
         */
        public static final String ACCESS_LEVEL = legacyApi? "visibility" : "accessLevel";
