package SmarTrek.Android_Platform.Overlays;

import java.util.ArrayList;

import SmarTrek.Android_Platform.Confirm_Trip_Activity;
import SmarTrek.Android_Platform.AdjustableCouponDisplay.CouponLayout;
import SmarTrek.Android_Platform.Utilities.Coupon;
import SmarTrek.Android_Platform.Utilities.Route;
import SmarTrek.Android_Platform.mapviewballon.BalloonItemizedOverlay;
...
//	private Bitmap bitmap;
	...
	protected boolean onBalloonTap(int index, OverlayItem item) {
		if (enabled) {
			...
			Intent intent = new Intent(mContext, Confirm_Trip_Activity.class);
